(function (global, factory) {
  ...
  (global = global || self, global.VuePopper = factory());
  ...
  var script = {
    ...
    watch: {
      showPopper: function showPopper(value) {
        if (value) {
          ...
          if (this.popperJS) {
            var eventListenersIndex = this.popperJS.state.options.modifiers.findIndex(function (modifier) {
              return modifier.name === "eventListeners";
            });

            if (eventListenersIndex > -1) {
              this.popperJS.state.options.modifiers[eventListenersIndex].options = {
                scroll: true,
                resize: true
              };
            } else {
          ...
          if (this.popperJS) {
            var _eventListenersIndex = this.popperJS.state.options.modifiers.findIndex(function (modifier) {
              return modifier.name === "eventListeners";
            });

            if (_eventListenersIndex > -1) {
              this.popperJS.state.options.modifiers[_eventListenersIndex].options = {
                scroll: false,
                resize: false
              };
            } else {
    ...
    created: function created() {
      ...
      this.popperOptions = _objectSpread({}, this.popperOptions, this.options);
    },
    ...
    methods: {
      ...
      makePopper: function makePopper() {
        var _this = this;
        ...
        this.$nextTick(function () {
          ...
          if (_this.boundariesSelector) {
            ...
            if (boundariesElement) {
              _this.popperOptions.modifiers = _toConsumableArray(_this.popperOptions.modifiers);

              var preventOverflowModifierIndex = _this.popperOptions.modifiers.findIndex(function (modifier) {
                return modifier.name === "preventOverflow";
              });

              if (preventOverflowModifierIndex) {
                _this.popper.modifiers[preventOverflowModifierIndex] = {
                  name: "preventOverflow",
                  options: _objectSpread({}, _this.popper.modifiers[preventOverflowModifierIndex].options, {
          ...
          var reference = _this.anchorElm ? _this.anchorElm : _this.referenceElm;
          _this.popperJS = createPopper(reference, _this.popper, _this.popperOptions);
        });
      },
  ...
  script.__file = "/Users/jakebohlken/vue-popper/src/component/popper.js.vue";
  /* template */
